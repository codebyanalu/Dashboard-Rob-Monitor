var CALENDAR25 = {
  ...
  fim: '30/10',
  dias: {
    d1: { label: 'Segunda-feira', display: '26/10' },
    d2: { label: 'Terça-feira', display: '27/10' },
    d3: { label: 'Quarta-feira', display: '28/10' },
    d4: { label: 'Quinta-feira', display: '29/10' },
    d5: { label: 'Sexta-feira', display: '30/10' }
  }
};
